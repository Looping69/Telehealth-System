 ...
 * Main dashboard with key metrics, recent activity, and upcoming appointments
 */
...
const RecentActivity: React.FC = () => {
  ...
  const activities = tasks?.map((task, index) => {
    ...
    return {
      id: task.id || index,
      type: 'task',
      message: convertedTask.description || 'Task updated',
    ...
    return (
      <Container size="xl" py="md">
        <Alert icon={<AlertCircle size={16} />} title="Error" color="red">
          Failed to load dashboard metrics. Please check your connection to the FHIR server.
        </Alert>
      </Container>
    );
  }
      ...
      <Stack gap="lg">
        ...
        <Group justify="space-between" align="center">
          <div>
            ...
            <Text c="dimmed">Welcome back! Here's what's happening today.</Text>
          </div>
          <Group>
            ...
            <Card shadow="sm" padding="lg" radius="md" withBorder h={400}>
              ...
              >
                <Stack align="center" gap="sm">
                  ...
                  <Text c="dimmed">Chart visualization with FHIR data</Text>
                  <Text size="sm" c="dimmed">Coming soon with analytics integration</Text>
                </Stack>
              </div>
            </Card>
          </Grid.Col>
